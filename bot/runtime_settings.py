...
FIELDS: tuple[SettingField, ...] = (
    SettingField(
        ...
        "Trading mode",
        "choice",
        "Paper simulates; live hits the real book when allowed.",
        choices=("paper", "live"),
    ),
    SettingField(
        "DRY_RUN",
    ...
    SettingField(
        ...
        "Trading mode",
        "bool",
        "Must be on for real orders in live mode.",
    ),
    SettingField(
        "PRIVATE_KEY",
        "Private key",
        "Secrets",
        "str",
        "Signing key. Blank keeps the stored value.",
        secret=True,
    ),
    SettingField(
        "FUNDER_ADDRESS",
        ...
        "Secrets",
        "str",
        "Wallet address for proxy modes. Blank keeps stored.",
        secret=True,
    ),
    SettingField(
        "POLYGON_RPC_URL",
        ...
        "Secrets",
        "str",
        "Chain RPC endpoint. Blank keeps stored.",
        secret=True,
    ),
    SettingField(
        "PM_CONNECTION_HOST",
    ...
    SettingField(
        ...
        "Polymarket connection",
        "int",
        "Network id (Polygon mainnet is 137).",
    ),
    SettingField(
        ...
        "Polymarket connection",
        "choice",
        "How orders are signed (EOA vs proxy).",
        choices=("0", "1", "2"),
    ),
    SettingField(
        "TRADE_LEDGER_PATH",
    ...
    SettingField(
        ...
        "Strategy",
        "int",
        "Ignore markets ending farther out than this.",
    ),
    SettingField(
        ...
        "Strategy",
        "int",
        "Earliest acceptable time-to-resolution.",
    ),
    SettingField(
        ...
        "Strategy",
        "int",
        "Latest acceptable time-to-resolution.",
    ),
    SettingField(
    ...
    SettingField(
        ...
        "Strategy",
        "float",
        "USD per trade when set; otherwise automatic sizing.",
    ),
    SettingField(
    ...
    SettingField(
        ...
        "Strategy",
        "int",
        "New opens allowed per cycle (-1 = no cap).",
    ),
    SettingField(
        ...
        "Strategy",
        "bool",
        "Stop opening once the cap is hit.",
    ),
    SettingField(
    ...
    SettingField(
        ...
        "Risk",
        "float",
        "Cap on total open notional across markets.",
    ),
    SettingField(
        ...
        "Risk",
        "float",
        "Cap on open notional in one market.",
    ),
    SettingField(
        ...
        "Risk",
        "float",
        "Daily loss from the session high that trips the breaker.",
    ),
    SettingField(
        ...
        "Risk",
        "float",
        "Pause after a kill before new entries.",
    ),
    SettingField(
        ...
        "Risk",
        "float",
        "Warm-up before drawdown rules apply.",
    ),
    SettingField(
        ...
        "Risk",
        "int",
        "Balance samples needed before drawdown checks.",
    ),
)
